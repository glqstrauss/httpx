...
class TestRequests:
    ...
    @pytest.mark.xfail(reason="HTTPX does not provide response.elapsed")
    ...
    @pytest.mark.xfail(reason="HTTPX uses b'' instead - probably OK.")
    ...
    @pytest.mark.xfail(
        reason=(
            "HTTPX sync responses aren't iterable - although async responses "
            "have .stream() for that purpose."
        ),
        raises=TypeError,
    )
    ...
    @pytest.mark.xfail(reason="Incompatible regression test.")
    ...
    @pytest.mark.xfail(
        reason="HTTPX doesn't allow changing the response URL.", raises=AttributeError
    )
    ...
    @pytest.mark.xfail(reason="HTTPX responses aren't iterable.")
